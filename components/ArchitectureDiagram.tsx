  ...
  return (
    <div className="relative max-w-[700px] mx-auto py-8">
      <svg viewBox="0 0 700 520" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
        ...
        {/* Arrow down */}
        <line x1="350" y1="54" x2="350" y2="90" stroke="#63b3ff" strokeWidth="1" strokeOpacity="0.5" />
        ...
        {/* Arrow down */}
        <line x1="350" y1="186" x2="350" y2="210" stroke="#63b3ff" strokeWidth="1" strokeOpacity="0.5" />
        ...
        {[0, 1, 2, 3, 4].map((i) => {
          ...
          return (
            <g key={i}>
              <line x1={startX} y1="266" x2={endX} y2={endY} stroke="#63b3ff" strokeWidth="1" strokeOpacity="0.3" />
        ...
        {/* Loop back arrow */}
        <path d="M 650 365 Q 680 365 680 250 Q 680 130 520 128"
        ...
        {/* Arrow to output */}
        <line x1="350" y1="390" x2="350" y2="440" stroke="#34d399" strokeWidth="1" strokeOpacity="0.5" />
